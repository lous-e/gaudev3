...
function HTopbar({ crumb = "Workspace · Deals", onNewIntent }) {
  return (
    <div style={{
      ...
      <HButton kind="ghost">Invite agent</HButton>
...
function HShell({ tab, setTab, crumb, children, onNewIntent }) {
  return (
    <div style={{
      ...
      <HSidebar tab={tab} setTab={setTab} />
      <div style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <HTopbar crumb={crumb} onNewIntent={onNewIntent} />
